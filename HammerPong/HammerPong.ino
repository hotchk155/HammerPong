...
#define PIX_LENGTH 150                        // Number of pixels in a strip
#define PIX_BUFSSIZE (3 * PIX_LENGTH)         // Number of bytes per strip (24 bit RGB)
#define PIX_NUMBUFFERS 6                      // Total number of strips in the application

// Define the data pins for the strips. They must all be on the same GPIO port
#define P_STRIP0 5
#define P_STRIP1 6
#define P_STRIP2 7
#define P_STRIP3 36
...
byte pixBuffer[PIX_NUMBUFFERS][PIX_BUFSSIZE]; // The huge display buffer!
...
void pixUpdate()
{
  ...
  for(int index = 0; index < PIX_BUFSSIZE; ++index)  
  {          
